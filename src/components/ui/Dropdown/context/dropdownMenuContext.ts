import { createContext, type RefObject, useCallback, useRef, useState } from 'react'
...
export function useDropdownMenuContext<E extends HTMLElement>(menuRef: RefObject<E | null>) {
