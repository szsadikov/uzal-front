...
import type { ColorLevel, CommonProps, TypeAttributes } from '../@types/common'
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
	...
	const twoToneColor = () => {
		const btn = {
			...
			hoverColor: active ? '' : `hover:bg-${buttonColor}-100 dark:hover:bg-${buttonColor}-500/30`,
	...
	return (
		<button ref={ref} type={type} className={classes} {...rest} onClick={handleClick}>
			{renderChildren()}
		</button>
	)
})
