...
const NewApplicationsEdit = ({ id, isOpen, setIsOpen, refetch }: Props) => {
	...
	const onSubmit = async (data: FormModel) => {
		...
		const formData: FormModel = {
			...data,
			phone_number: data.phone_number.startsWith('998')
				? data.phone_number
	...
	useEffect(() => {
		if (application && techs && techs.length) {
			setValue('tech', application.tech?.id || null)
		}
	}, [techs])
...
export default NewApplicationsEdit
