...
import NewApplicationsTable from './components/NewApplicationsTable'
import NewApplicationsTools from './components/NewApplicationsTools'
...
const NewApplicationsList = () => {
	...
	const [filters, setFilters] = useState({} as FilterQueries) // status_group: 'new'
